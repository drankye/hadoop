...
public final class FbFileUnderConstructionFeature extends Table {
  public static FbFileUnderConstructionFeature getRootAsIntelFileUnderConstructionFeature(ByteBuffer _bb) { return getRootAsIntelFileUnderConstructionFeature(_bb, new FbFileUnderConstructionFeature()); }
  public static FbFileUnderConstructionFeature getRootAsIntelFileUnderConstructionFeature(ByteBuffer _bb, FbFileUnderConstructionFeature obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelFileUnderConstructionFeature(FlatBufferBuilder builder,
    ...
    return FbFileUnderConstructionFeature.endIntelFileUnderConstructionFeature(builder);
  }
