...
public final class FbDirectoryDiff extends Table {
  ...
  public FbINodeDirectory snapshotCopy() { return snapshotCopy(new FbINodeDirectory()); }
  public FbINodeDirectory snapshotCopy(FbINodeDirectory obj) { int o = __offset(12); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  ...
  public static int createFbDirectoryDiff(FlatBufferBuilder builder,
    ...
    FbDirectoryDiff.addDeletedINodeRef(builder, deletedINodeRef);
    FbDirectoryDiff.addDeletedINode(builder, deletedINode);
    FbDirectoryDiff.addCreatedListSize(builder, createdListSize);
    FbDirectoryDiff.addSnapshotCopy(builder, snapshotCopy);
    FbDirectoryDiff.addName(builder, name);
