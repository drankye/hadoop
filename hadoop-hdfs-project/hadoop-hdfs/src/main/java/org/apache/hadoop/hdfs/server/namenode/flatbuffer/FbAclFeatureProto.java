...
public final class FbAclFeatureProto extends Table {
  public static FbAclFeatureProto getRootAsIntelAclFeatureProto(ByteBuffer _bb) { return getRootAsIntelAclFeatureProto(_bb, new FbAclFeatureProto()); }
  public static FbAclFeatureProto getRootAsIntelAclFeatureProto(ByteBuffer _bb, FbAclFeatureProto obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelAclFeatureProto(FlatBufferBuilder builder,
    ...
    return FbAclFeatureProto.endIntelAclFeatureProto(builder);
  }
