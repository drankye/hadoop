...
public final class FbSecretManagerSection extends Table {
  public static FbSecretManagerSection getRootAsIntelSecretManagerSection(ByteBuffer _bb) { return getRootAsIntelSecretManagerSection(_bb, new FbSecretManagerSection()); }
  public static FbSecretManagerSection getRootAsIntelSecretManagerSection(ByteBuffer _bb, FbSecretManagerSection obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelSecretManagerSection(FlatBufferBuilder builder,
    ...
    return FbSecretManagerSection.endIntelSecretManagerSection(builder);
  }
