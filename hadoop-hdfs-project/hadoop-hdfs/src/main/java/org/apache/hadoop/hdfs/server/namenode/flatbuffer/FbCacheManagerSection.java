...
public final class FbCacheManagerSection extends Table {
  public static FbCacheManagerSection getRootAsIntelCacheManagerSection(ByteBuffer _bb) { return getRootAsIntelCacheManagerSection(_bb, new FbCacheManagerSection()); }
  public static FbCacheManagerSection getRootAsIntelCacheManagerSection(ByteBuffer _bb, FbCacheManagerSection obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelCacheManagerSection(FlatBufferBuilder builder,
    ...
    return FbCacheManagerSection.endIntelCacheManagerSection(builder);
  }
