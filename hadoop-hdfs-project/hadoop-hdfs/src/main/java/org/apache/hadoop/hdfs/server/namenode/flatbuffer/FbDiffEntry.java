...
public final class FbDiffEntry extends Table {
  public static FbDiffEntry getRootAsIntelDiffEntry(ByteBuffer _bb) { return getRootAsIntelDiffEntry(_bb, new FbDiffEntry()); }
  public static FbDiffEntry getRootAsIntelDiffEntry(ByteBuffer _bb, FbDiffEntry obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelDiffEntry(FlatBufferBuilder builder,
    ...
    return FbDiffEntry.endIntelDiffEntry(builder);
  }
