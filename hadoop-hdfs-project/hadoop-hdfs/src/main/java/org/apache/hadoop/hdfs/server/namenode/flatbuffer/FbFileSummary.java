...
public final class FbFileSummary extends Table {
  public static FbFileSummary getRootAsIntelFileSummary(ByteBuffer _bb) { return getRootAsIntelFileSummary(_bb, new FbFileSummary()); }
  public static FbFileSummary getRootAsIntelFileSummary(ByteBuffer _bb, FbFileSummary obj) {
  ...
  public static int createIntelFileSummary(FlatBufferBuilder builder,
    ...
    return FbFileSummary.endIntelFileSummary(builder);
  }
