...
public final class FbSnapshot extends Table {
  public static FbSnapshot getRootAsIntelSnapshot(ByteBuffer _bb) { return getRootAsIntelSnapshot(_bb, new FbSnapshot()); }
  public static FbSnapshot getRootAsIntelSnapshot(ByteBuffer _bb, FbSnapshot obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelSnapshot(FlatBufferBuilder builder,
    ...
    return FbSnapshot.endIntelSnapshot(builder);
  }
