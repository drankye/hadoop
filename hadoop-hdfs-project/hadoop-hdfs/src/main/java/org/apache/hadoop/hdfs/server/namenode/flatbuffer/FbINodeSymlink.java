...
public final class FbINodeSymlink extends Table {
  public static FbINodeSymlink getRootAsIntelINodeSymlink(ByteBuffer _bb) { return getRootAsIntelINodeSymlink(_bb, new FbINodeSymlink()); }
  public static FbINodeSymlink getRootAsIntelINodeSymlink(ByteBuffer _bb, FbINodeSymlink obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelINodeSymlink(FlatBufferBuilder builder,
    ...
    return FbINodeSymlink.endIntelINodeSymlink(builder);
  }
