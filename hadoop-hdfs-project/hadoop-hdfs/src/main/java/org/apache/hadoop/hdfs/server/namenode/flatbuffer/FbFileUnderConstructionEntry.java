...
public final class FbFileUnderConstructionEntry extends Table {
  public static FbFileUnderConstructionEntry getRootAsIntelFileUnderConstructionEntry(ByteBuffer _bb) { return getRootAsIntelFileUnderConstructionEntry(_bb, new FbFileUnderConstructionEntry()); }
  public static FbFileUnderConstructionEntry getRootAsIntelFileUnderConstructionEntry(ByteBuffer _bb, FbFileUnderConstructionEntry obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelFileUnderConstructionEntry(FlatBufferBuilder builder,
    ...
    return FbFileUnderConstructionEntry.endIntelFileUnderConstructionEntry(builder);
  }
