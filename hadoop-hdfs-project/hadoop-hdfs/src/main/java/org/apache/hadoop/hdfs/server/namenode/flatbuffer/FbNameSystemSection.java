...
public final class FbNameSystemSection extends Table {
  public static FbNameSystemSection getRootAsIntelNameSystemSection(ByteBuffer _bb) { return getRootAsIntelNameSystemSection(_bb, new FbNameSystemSection()); }
  public static FbNameSystemSection getRootAsIntelNameSystemSection(ByteBuffer _bb, FbNameSystemSection obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelNameSystemSection(FlatBufferBuilder builder,
    ...
    return FbNameSystemSection.endIntelNameSystemSection(builder);
  }
