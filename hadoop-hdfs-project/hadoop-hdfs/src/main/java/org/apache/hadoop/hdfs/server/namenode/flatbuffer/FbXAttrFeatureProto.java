...
public final class FbXAttrFeatureProto extends Table {
  public static FbXAttrFeatureProto getRootAsIntelXAttrFeatureProto(ByteBuffer _bb) { return getRootAsIntelXAttrFeatureProto(_bb, new FbXAttrFeatureProto()); }
  public static FbXAttrFeatureProto getRootAsIntelXAttrFeatureProto(ByteBuffer _bb, FbXAttrFeatureProto obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelXAttrFeatureProto(FlatBufferBuilder builder,
    ...
    return FbXAttrFeatureProto.endIntelXAttrFeatureProto(builder);
  }
