...
public final class FbPersistToken extends Table {
  public static FbPersistToken getRootAsFbPersistToken(ByteBuffer _bb) { return getRootAsFbPersistToken(_bb, new FbPersistToken()); }
  public static FbPersistToken getRootAsFbPersistToken(ByteBuffer _bb, FbPersistToken obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createFbPersistToken(FlatBufferBuilder builder,
      long version,
      int owner,
      int renewer,
      int realUser,
    ...
    return FbPersistToken.endFbPersistToken(builder);
  }

  public static void startFbPersistToken(FlatBufferBuilder builder) { builder.startObject(9); }
  ...
  public static int endFbPersistToken(FlatBufferBuilder builder) {
    int o = builder.endObject();
    return o;
  }
  public static void finishFbPersistTokenBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
};
