...
public final class FbSnapshotSection extends Table {
  public static FbSnapshotSection getRootAsIntelSnapshotSection(ByteBuffer _bb) { return getRootAsIntelSnapshotSection(_bb, new FbSnapshotSection()); }
  public static FbSnapshotSection getRootAsIntelSnapshotSection(ByteBuffer _bb, FbSnapshotSection obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelSnapshotSection(FlatBufferBuilder builder,
    ...
    return FbSnapshotSection.endIntelSnapshotSection(builder);
  }
