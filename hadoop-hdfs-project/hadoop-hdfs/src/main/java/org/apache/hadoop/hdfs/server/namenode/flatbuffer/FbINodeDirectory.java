...
public final class FbINodeDirectory extends Table {
  ...
  public FbAclFeatureProto acl(FbAclFeatureProto obj) { int o = __offset(12); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  public FbXAttrFeatureProto xAttrs() { return xAttrs(new FbXAttrFeatureProto()); }
  public FbXAttrFeatureProto xAttrs(FbXAttrFeatureProto obj) { int o = __offset(14); return o != 0 ? obj.__init(__indirect(o + bb_pos), bb) : null; }
  ...
  public static int createFbINodeDirectory(FlatBufferBuilder builder,
    ...
    FbINodeDirectory.addPermission(builder, permission);
    FbINodeDirectory.addDsQuota(builder, dsQuota);
    FbINodeDirectory.addNsQuota(builder, nsQuota);
    FbINodeDirectory.addModificationTime(builder, modificationTime);
