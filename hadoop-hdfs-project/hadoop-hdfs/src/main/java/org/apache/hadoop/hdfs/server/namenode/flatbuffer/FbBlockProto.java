...
public final class FbBlockProto extends Table {
  public static FbBlockProto getRootAsIntelBlockProto(ByteBuffer _bb) { return getRootAsIntelBlockProto(_bb, new FbBlockProto()); }
  public static FbBlockProto getRootAsIntelBlockProto(ByteBuffer _bb, FbBlockProto obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelBlockProto(FlatBufferBuilder builder,
    ...
    return FbBlockProto.endIntelBlockProto(builder);
  }
