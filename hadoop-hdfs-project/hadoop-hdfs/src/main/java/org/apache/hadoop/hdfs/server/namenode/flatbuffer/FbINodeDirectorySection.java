...
public final class FbINodeDirectorySection extends Table {
  public static FbINodeDirectorySection getRootAsIntelINodeDirectorySection(ByteBuffer _bb) { return getRootAsIntelINodeDirectorySection(_bb, new FbINodeDirectorySection()); }
  public static FbINodeDirectorySection getRootAsIntelINodeDirectorySection(ByteBuffer _bb, FbINodeDirectorySection obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
