...
public final class FbINodeSection extends Table {
  public static FbINodeSection getRootAsIntelINodeSection(ByteBuffer _bb) { return getRootAsIntelINodeSection(_bb, new FbINodeSection()); }
  public static FbINodeSection getRootAsIntelINodeSection(ByteBuffer _bb, FbINodeSection obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__init(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createIntelINodeSection(FlatBufferBuilder builder,
    ...
    return FbINodeSection.endIntelINodeSection(builder);
  }
